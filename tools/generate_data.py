...
IMAGES = {"乾": "天", "兌": "澤", "離": "火", "震": "雷",
          "巽": "風", "坎": "水", "艮": "山", "坤": "地"}
# Canonical hexagram titles are the name vocabulary; the 64 records below are
# still generated from trigram bits and the Bagong algorithm.  Keeping the
# vocabulary keyed by upper/lower trigram avoids silently reducing a title to
# its two image characters (for example 水雷屯 -> 水雷).
HEXAGRAM_TITLES = {
...
def hexagram_name(lines: tuple[int, ...]) -> str:
    ...
    return HEXAGRAM_TITLES[(upper, lower)]
